...
describe('Address', () => {
    ...
    it('should throw if address is invalid', () => {
        ...
        expect(Address_1.Address.isRaw('0:2cf55953e92efbeadab7ba725c3f93a0b23f842cbba72d7b8e6f510a70e422')).toBe(false);
        expect(() => {
            Address_1.Address.parseRaw('0:2cf55953e92efbeadab7ba725c3f93a0b23f842cbba72d7b8e6f510a70e422e');
        }).toThrowError('Invalid address hash length: 31');
        expect(Address_1.Address.isRaw('0:2cf55953e92efbeadab7ba725c3f93a0b23f842cbba72d7b8e6f510a70e422e')).toBe(false);
        expect(() => {
        ...
        expect(Address_1.Address.isFriendly('ton://transfer/EQDXDCFLXgiTrjGSNVBuvKPZVYlPn3J_u96xxLas3_yoRWRk')).toBe(false);
        expect(() => {
            Address_1.Address.parseFriendly('0:EQDXDCFLXgiTrjGSNVBuvKPZVYlPn3J_u96xxLas3_yoRWRk');
        }).toThrowError('Unknown address type');
        expect(Address_1.Address.isFriendly('0:EQDXDCFLXgiTrjGSNVBuvKPZVYlPn3J_u96xxLas3_yoRWRk')).toBe(false);
        expect(() => {
            Address_1.Address.parseFriendly('!@#$%^&*AAAAAAAAAAAAAA AAAAAAAAAA AAAAAAAAAAAA A');
        }).toThrowError('Unknown address type');
        expect(Address_1.Address.isFriendly('!@#$%^&*AAAAAAAAAAAAAA AAAAAAAAAA AAAAAAAAAAAA A')).toBe(false);
        expect(() => {
            Address_1.Address.parseFriendly('                                                ');
        }).toThrowError('Unknown address type');
        expect(Address_1.Address.isFriendly('                                                ')).toBe(false);
    });
});
